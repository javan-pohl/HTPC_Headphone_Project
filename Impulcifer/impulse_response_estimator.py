...
class ImpulseResponseEstimator(object):
    ...
    def __init__(self, min_duration=5.0, fs=44100):
        ...
        # Start frequency is approximately 78 Hz, scaled to ensure integer number of octaves between
        # start and end frequencies
        target_low = 78
        self.n_octaves = np.floor(np.log2(self.high / target_low))  # Use floor to keep frequency above 78Hz
